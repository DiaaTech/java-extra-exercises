...
public class Exercises {
	...
	public int[] makeLast(int[] nums) {
		...
		int []newArray = new int[l];
		 newArray[l-1] = nums[nums.length-1];
		return newArray;
	}
	...
	/*
	 11. Start with 2 int arrays, a and b, of any length. Return how many of the arrays have
	...
	/*
	 13. Given an array of ints of even length, return a new array length 2 containing 
	...
	/*
	 21. Given start and end numbers, return a new array containing the sequence of integers 
	 from start up to but  not including end,
	  so start=5 and end=10 yields {5, 6, 7, 8, 9}. The end number will be greater or equal 
	...
	/*
	 23. You have a green lottery ticket, with ints a, b, and c on it. 
	...
	/*
	 25. Given three ints, a b c, one of them is small, one is medium and one is large.
